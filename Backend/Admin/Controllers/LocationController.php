<?php 
	...
	class LocationController extends LocationModel{
		public function read(){
			...
			//load view
			include "Views/LocationView.php";
		}
		//edit ban ghi
		public function update(){
			...
			$action = "index.php?controller=location&action=updatePost&id=$id";
			//goi view
			include "Views/LocationCreateUpdateView.php";
		}
		...
		public function updatePost(){
			...
			echo "<script>location.href='index.php?controller=location&action=read';</script>";
		}
		//create ban ghi
		public function create(){
			$action = "index.php?controller=location&action=createPost";
			//goi view
			include "Views/LocationCreateUpdateView.php";
		}
