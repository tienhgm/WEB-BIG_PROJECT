<div class="col-md-12">  
    <div class="card card-primary">
        ...
        <h6 class="card-header" style="color: white;background:#C79F32">Create-Edit AdminUser</h6>
        <form method="post" action="<?php echo $action; ?>" style="margin:25px 0;">
            ...
            <!-- rows -->
            <div class="row" style="margin-top:5px;">
                <div class="col-md-1" style="margin-left: 2%;">Email</div>
                <div class="col-md-10">
            ...
            <!-- rows -->
            <div class="row" style="margin-top:5px;">
                <div class="col-md-1" style="margin-left: 2%;">Password</div>
                <div class="col-md-10">
