...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        <a class="nav-link" href="index.php?controller=adminUsers&action=read">
          <i class="fas fa-fw fa-cog"></i>
      ...
      <li class="nav-item">
        <a class="nav-link" href="index.php?controller=renterUsers&action=read">
          <i class="fas fa-fw fa-cog"></i>
          <span>Renter-users</span></a>
      </li>
